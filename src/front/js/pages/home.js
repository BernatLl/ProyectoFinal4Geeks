          ...
          <Row className="justify-content-md-center">
            <Col lg="6">
              <div className="mt-m" id="Bourdain">
                <h3>
                  If I'm an advocate for anything, it's to move. As far as you
                  can, as much as you can. Across the ocean, or simply across
                  the river. Walk in someone else's shoes or at least eat their
              ...
              <div className="Students">
                <div className="StudentsText">
                  ...
                  <p>
                    ...
                    a digital library with hundreds of professional and amateur
                    cooks around the world, do you want to learn how to cut like
                    a professional. Do you want to learn about Venezuelan food,
                    New Zeleand, Canada, Scotland, etc? We give the chance to
                    professional or no professional chefs around the world that
                    want to share their recipe or skill with the rest of the
                    world!!!!{" "}
                  </p>
                </div>
              </div>
              ...
              <div className="Students">
                <div className="StudentsText">
                  <p>
                    ...
                    Welcome to "We Cook", with us you will be able to access to
                    a hundreds of students that like cook around the world, do
                    you want to teach how to cut like a professional We give the
                    chance to colaborate and share your recipe or skill with the
                    rest of the world!!!!{" "}
                  </p>
                  <img id="foto" className="StuPic" src={Teacher}></img>
                </div>
              </div>
            </Row>
          </div>
