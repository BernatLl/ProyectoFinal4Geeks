...
export const CourseView = () => {
  ...
  return (
      ...
      <div className="container">
        ...
        <h4>{store.courseDetail.description}</h4>
        <h4>{store.courseDetail.ingredient}</h4>
        <h4>{store.courseDetail.list_ingredients}</h4>
        <h4>{store.courseDetail.price}</h4>
        <h4>{store.courseDetail.img}</h4>
      </div>
